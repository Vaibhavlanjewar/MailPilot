        ...
        <div className="space-y-5">
          <div className="rounded-2xl border border-surface-border bg-slate-50 p-4">
            ...
            <div className="hidden gap-2 lg:grid lg:grid-cols-[1fr_auto_1fr_auto_1fr_auto_1fr]">
              <FlowBlock
                title="Account"
                subtitle="Profile menu + sender settings"
              />
              <Arrow />
              <FlowBlock
                title="Email Connect"
                subtitle="Profile menu status bullet + Gmail OAuth"
              />
              <Arrow />
              <FlowBlock
                title="Audience"
                subtitle="Contacts from CSV / manual"
              />
              <Arrow />
              <FlowBlock
                title="Campaign"
                subtitle="Template + recipients + send"
              />
            </div>
            ...
            <div className="hidden gap-2 lg:grid lg:grid-cols-[1fr_auto_1fr]">
              <FlowBlock
                title="Queue + Worker"
                subtitle="Jobs process sends and retries"
              />
              <Arrow />
              <FlowBlock
                title="Tracking"
                subtitle="Dashboard, Campaign status, Analytics"
              />
            </div>
